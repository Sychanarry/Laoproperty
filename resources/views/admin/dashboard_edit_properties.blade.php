   ...
   @include('admin.body.pagecontent')
    <main id="content" class="fontfamily">
      <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10 my-profile">
        ...
        <div class="collapse-tabs new-property-step fontfamily">
      ...
      role="tablist">
            <li class="nav-item col">
             ...
             href="#description"
             role="tab"
             aria-controls="description" aria-selected="true"><span class="number">1.</span> <strong class="fontweight"> ຄຳອະທິບາຍ</strong></a>
            </li>
            <li class="nav-item col">
             ...
             href="#media"
             role="tab"
             aria-controls="media" aria-selected="false"><span class="number">2.</span><strong class="fontweight"> ຮູບພາບ</strong></a>
            </li>
            <li class="nav-item col">
              <a class="nav-link bg-transparent shadow-none py-2 font-weight-500 text-center lh-214 d-block"
             id="location-tab"
             ...
             href="#location"
             role="tab"
             aria-controls="location" aria-selected="false"><span class="number">3.</span><strong class="fontweight"> ຕຳແໜ່ງ</strong></a>
            </li>
            <li class="nav-item col">
              <a class="nav-link bg-transparent shadow-none py-2 font-weight-500 text-center lh-214 d-block"
             id="detail-tab"
             ...
             href="#detail"
             role="tab"
             aria-controls="detail" aria-selected="false"><span class="number">4.</span> <strong class="fontweight">ລາຍລະອຽດ</strong></a>
            </li>
            <li class="nav-item col">
              <a class="nav-link bg-transparent shadow-none py-2 font-weight-500 text-center lh-214 d-block"
             id="amenities-tab"
             ...
             href="#amenities"
             role="tab"
             aria-controls="amenities" aria-selected="false"><span class="number">5.</span><strong class="fontweight"> ສິ່ງອຳນວຍຄວາມສະດວກ</strong></a>
            </li>
          </ul>
          <form action="{{route('postestates.update',$postestate->post_id)}}" method="POST"  enctype="multipart/form-data">
                                                    ...
                                                    <div class="card mb-6">
                                                        <div class="card-body p-6">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12">
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <input type="hidden" class="form-control form-control-lg border-0"  name="post_id" value="{{$postestate->post_id}}">
                                                                        <input type="text" class="form-control form-control-lg border-0" id="title" name="title" value="{{old('title',$postestate->title)}}">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-xxl-5 col-xl-4 col-lg-4 col-md-10 col-sm-9 col-8">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"maxlength = "12" class="form-control form-control-lg border-0" id="comment" name="sale_price" value="{{old('sale_price',$postestate->sale_price)}}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xxl-5 col-xl-4 col-lg-4 col-md-10 col-sm-9 col-8">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"maxlength = "12" class="form-control form-control-lg border-0" id="text1" name="rent_price" value="{{old('rent_price',$postestate->rent_price)}}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12">
                                                                    <div class="form-group">
                                                                        <label for="title" class="text-heading">ມື້ໂພສ</label>
                                                                        <input type="date" id="today" class="form-control form-control-lg border-0" name="post_date" value="{{ old('post_date', $postestate->post_date ?? null) }}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12">
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <input type="date" class="form-control form-control-lg border-0" id="e" name="public_date" value="{{ old('public_date', $postestate->public_date ?? null) }}"/>
                                                                    </div>
                                                                </div>
                                                                <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12">
                                                                    <div class="form-group mb-md-0">
                                                                        ...
                                                                        <select class="form-control border-0 shadow-none form-control-lg selectpicker" title="ເລືອກປະເພດ" data-style="btn-lg py-2 h-52" id="property_mode" name="property_mode">
                                                                            ...
                                                                            <option value="1" {{((old('property_mode',$postestate->property_mode ?? null)==1))? "selected":""}}>ຊື້</option>
                                                                            <option value="2"  {{((old('property_mode',$postestate->property_mode ?? null)==2))? "selected":""}}>ຂາຍ</option>
                                                                            <option value="3"  {{((old('property_mode',$postestate->property_mode ?? null)==3))? "selected":""}}>ຂາຍ ແລະ ເຊົ່າ</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12">
                                                                    <div class="form-group mb-md-0">
                                                                        ...
                                                                        <select class="form-control border-0 shadow-none form-control-lg selectpicker" data-style="btn-lg py-2 h-52" id="type_id" name="type_id">
                                                                            ...
                                                                            <option value="1" {{((old('type_id',$postestate->type_id ?? null)==1))? "selected":""}}>ເຮືອນຫ້ອງແຖວ</option>
                                                                            <option value="2" {{((old('type_id',$postestate->type_id ?? null)==2))? "selected":""}}>ເຮືອນວິນລາ</option>
                                                                            <option value="3" {{((old('type_id',$postestate->type_id ?? null)==3))? "selected":""}}>ເຮືອນພ້ອມດິນ</option>
                                                                            <option value="4" {{((old('type_id',$postestate->type_id ?? null)==4))? "selected":""}}>ຮ້ານຂາຍເຄື່ອງ</option>
                                                                            <option value="5" {{((old('type_id',$postestate->type_id ?? null)==5))? "selected":""}}>ທີ່ດິນ</option>
                                                                            <option value="6" {{((old('type_id',$postestate->type_id ?? null)==6))? "selected":""}}>ທີ່ດິນການຄ້າ</option>
                                                                            <option value="7" {{((old('type_id',$postestate->type_id ?? null)==7))? "selected":""}}>ທີ່ດິນສວນ</option>
                                                                            <option value="8" {{((old('type_id',$postestate->type_id ?? null)==8))? "selected":""}}>ໂຮງແຮມ</option>
                                                                            <option value="9" {{((old('type_id',$postestate->type_id ?? null)==9))? "selected":""}}>ຫ້ອງການ</option>
                                                                            <option value="10" {{((old('type_id',$postestate->type_id ?? null)==10))? "selected":""}}>ສາງ</option>
                                                                            <option value="11" {{((old('type_id',$postestate->type_id ?? null)==11))? "selected":""}}>ໂຮງງານ</option>
                                                            ...
                                                            <div class="form-group mb-0">
                                                                ...
                                                                <textarea class="form-control border-0" rows="5" name="detail" id="description-01">{{old('detail',$postestate->detail)}}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="card mb-6 ">
                                                        <div class="card-body p-6">
                                                            <center>
                                                                ...
                                                                @foreach ($images_old as $images_old )
                                                                <input type="hidden"  name="old_image[]" accept="image/png, image/jpeg"  multiple value="{{ $images_old}}">
                                                                @endforeach
                                                        ...
                                                        <div class="card-body p-6">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group mb-md-0">
                                                                    ...
                                                                    <input type="text" name="video_link" class="form-control form-control-lg border-0" id="video" value="{{ old('video_link',$image_data->video_link) }}">
                                                                </div>
                                                                <div class="form-group mb-md-0">
                                                                    <label for="video" class="text-heading">ຄຳອະທິບາຍ</label>
                                                                    <textarea name="video_description" id="" class="form-control" cols="30" rows="8">{{ old('video_description',$image_data->video_description) }}</textarea>
                                                                </div>
                                                    ...
                                                    <div class="card mb-6">
                                                        <div class="card-body p-6">
                                                            ...
                                                            <div class="form-group mb-md-0">
                                                                ...
                                                                <select class="form-control border-0 shadow-none form-control-lg selectpicker " title="ເລືອກແຂວງ" data-style="btn-lg py-2 h-52" id="province_id" name="province_id">
                                                                    @foreach ($province as $province)
                                                                     ...
                                                                     <option value="{{$province->id}}" {{ (old('province_id', $postestate->province_id ?? null) == $province->id) ? "selected" : "" }}>{{$province->province_name}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                            <div class="form-group mb-md-0">
                                                                ...
                                                                <select class="form-control border-0 shadow-none form-control-lg selectpicker district" title="ເລືອກເມືອງ" data-style="btn-lg py-2 h-52" id="district_id" name="district_id">
                                                                    ...
                                                                    <option value="{{$district->district_id}}" {{ (old('province_id', $postestate->district_id ?? null) == $district->district_id) ? "selected" : "" }}>{{$district->district_name}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="form-group mb-md-0">
                                                                ...
                                                                <textarea name="description_map" id="" class="form-control" cols="30" rows="8">{{old('description_map',$postestate->description_map)}}</textarea>
                                                            </div>
                                                            ...
                                                            <div class="form-row mx-n2">
                                                                ...
                                                                <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                                                    ...
                                                                    <div class="form-group mb-md-0">
                                                                        ...
                                                                        <input type="text" class="form-control form-control-lg border-0" id="lat" name="lat" value="{{ old('lat',$postestate->lat) }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                                                    <div class="form-group mb-md-0">
                                                                        ...
                                                                        <input type="text" class="form-control form-control-lg border-0" id="lng" name="lng" value="{{ old('lng',$postestate->lng) }}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <br>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"maxlength = "2"  class="form-control form-control-lg border-0" id="bedroom" name="bedroom" value="{{ old('bedroom',$postestatedetail->bedroom)}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label for="bathroom" class="text-heading">ຈຳນວນຫ້ອງນ້ຳ</label>
                                                                <input type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"maxlength = "2" class="form-control form-control-lg border-0" id="bathroom" name="bathroom" value="{{ old('bathroom',$postestatedetail->bathroom)}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label for="floor_area" class="text-heading">ເນື້ອທີ່ຊັ້ນ(m<sup>2</sup>)</label>
                                                                <input type="number"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"maxlength = "2" class="form-control form-control-lg border-0" id="floor_area" name="floor_area" value="{{ old('floor_area',$postestatedetail->floor_area)}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"maxlength = "2" class="form-control form-control-lg border-0" id="car_space" name="car_space" value="{{ old('car_space',$postestatedetail->car_space)}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label for="land_area" class="text-heading">ເນື້ອທີ່ດິນ <span class="text-muted">(0x0)</span></label>
                                                                <input type="text" class="form-control form-control-lg border-0" id="land_area" name="land_area" value="{{ old('land_area',$postestatedetail->land_area)}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label for="total_floor" class="text-heading">ຈຳນວນຊັ້ນທັງໝົດ </label>
                                                                <input type="number"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"maxlength = "2" class="form-control form-control-lg border-0" id="total_floor" name="total_floor" value="{{ old('total_floor',$postestatedetail->total_floor)}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"maxlength = "2" class="form-control form-control-lg border-0" id="floor_level" name="floor_level" value="{{ old('floor_level',$postestatedetail->floor_level)}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control form-control-lg border-0" name="completion_year" value="{{ old('completion_year',$postestatedetail->completion_year)}}">
                                                                <!-- value="{{old('completion_year',date('Y',strtotime( now()->year )))}}"> -->
                                                            ...
                                                            <ul class="list-group list-group-no-border">
                                                                <li class="list-group-item px-0 pt-0 pb-2">
                                                                    <div class="custom-control custom-checkbox">
                                                                        ...
                                                                        @if($postestatedetail->air_conditioning == "1")
                                                                                checked
                                                                        @endif
                                                                        >
                                                                ...
                                                                <li class="list-group-item px-0 pt-0 pb-2">
                                                                    <div class="custom-control custom-checkbox">
                                                                        ...
                                                                        @if($postestatedetail->on_main_road == "1")
                                                                                checked
                                                                        @endif
                                                                        >
                                                                ...
                                                                <li class="list-group-item px-0 pt-0 pb-2">
                                                                    <div class="custom-control custom-checkbox">
                                                                        ...
                                                                        @if($postestatedetail->close_to_park == "1")
                                                                                checked
                                                                        @endif
                                                                        >
                                                            ...
                                                            <ul class="list-group list-group-no-border">
                                                                <li class="list-group-item px-0 pt-0 pb-2">
                                                                    <div class="custom-control custom-checkbox">
                                                                        ...
                                                                        @if($postestatedetail->hot_water == "1")
                                                                                checked
                                                                        @endif
                                                                        >
                                                                ...
                                                                <li class="list-group-item px-0 pt-0 pb-2">
                                                                    <div class="custom-control custom-checkbox">
                                                                        ...
                                                                        @if($postestatedetail->gym_center == "1")
                                                                                checked
                                                                        @endif
                                                                        >
                                                                ...
                                                                <li class="list-group-item px-0 pt-0 pb-2">
                                                                    <div class="custom-control custom-checkbox">
                                                                        ...
                                                                        @if($postestatedetail->close_to_school == "1")
                                                                                checked
                                                                        @endif
                                                                        >
                                                            ...
                                                            <ul class="list-group list-group-no-border">
                                                                <li class="list-group-item px-0 pt-0 pb-2">
                                                                    <div class="custom-control custom-checkbox">
                                                                        ...
                                                                        @if($postestatedetail->furniture == "1")
                                                                                checked
                                                                        @endif
                                                                        >
                                                                ...
                                                                <li class="list-group-item px-0 pt-0 pb-2">
                                                                    <div class="custom-control custom-checkbox">
                                                                        ...
                                                                        @if($postestatedetail->swimming_pool == "1")
                                                                                checked
                                                                        @endif
                                                                        >
                                                                ...
                                                                <li class="list-group-item px-0 pt-0 pb-2">
                                                                    <div class="custom-control custom-checkbox">
                                                                        ...
                                                                        @if($postestatedetail->ideal_for_investors == "1")
                                                                                checked
                                                                        @endif
                                                                        >
                                                                ...
                                                                <li class="list-group-item px-0 pt-0 pb-2">
                                                                    <div class="custom-control custom-checkbox">
                                                                        ...
                                                                        @if($postestatedetail->close_to_shop == "1")
                                                                                checked
                                                                        @endif
                                                                        >
                                                            ...
                                                            <ul class="list-group list-group-no-border">
                                                                <li class="list-group-item px-0 pt-0 pb-2">
                                                                    <div class="custom-control custom-checkbox">
                                                                        ...
                                                                        @if($postestatedetail->security == "1")
                                                                                checked
                                                                        @endif
                                                                        >
                                                                ...
                                                                <li class="list-group-item px-0 pt-0 pb-2">
                                                                    <div class="custom-control custom-checkbox">
                                                                        ...
                                                                        @if($postestatedetail->expat_friendly == "1")
                                                                                checked
                                                                        @endif
                                                                        >
