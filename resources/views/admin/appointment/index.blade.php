            ...
            <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
              <div class="d-flex flex-wrap flex-md-nowrap mb-6">
                <div class="mr-0 mr-md-auto">
                  <h2 class="mb-0 text-heading fs-22 lh-15 fontfamily">ການສະແດງຄວາມຄິດເຫັນ
                  </h2>
                </div>
                ...
                <table class="table table-hover bg-white border rounded-lg table-table-bordered" id="myTable">
                  <thead class="thead-sm thead-black">
                    <tr>
                      ...
                      <th scope="col" class="border-top-0 pt-5 pb-4">ເບີໂທ</th>
                      <th scope="col" class="border-top-0 pt-5 pb-4">ວັນທີ</th>
                      <th scope="col" class="border-top-0 pt-5 pb-4">ເວລາ</th>
                      <th scope="col" class="border-top-0 pt-5 pb-4">ເນື້ອໃນ</th>
                    </tr>
                  </thead>
                  <tbody>
                    @php
                    ...
                    <tr class="shadow-hover-xs-2 bg-hover-white">
                      ...
                      <td class="align-middle">{{$item->appointment_nameandlastname}}</td>
                      <td class="align-middle">{{$item->appointment_email}}</td>
                      <td class="align-middle">{{$item->appointment_tel}}</td>
                      <td class="align-middle">{{$item->appointment_date}}</td>
                      <td class="align-middle">{{$item->appointment_time}}</td>
                      <td class="align-middle">{{$item->appointment_content}}</td>
