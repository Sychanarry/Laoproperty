          ...
          <div class="row ml-xl-0 mr-xl-n6">
            <div class="col-lg-8 mb-6 mb-lg-0 pr-xl-6 pl-xl-0">
              <div class="position-relative">
                <img class="rounded-lg d-block" src="{{asset('assets/vendors/images/post-11.jpg')}}"
              ...
              <ul class="list-inline mt-4">
                <li class="list-inline-item mr-4"><img class="mr-1"
                                                           src="{{asset('assets/vendors/images/author-01.jpg')}}"
            ...
            <div class="media flex-wrap flex-sm-nowrap mb-8">
              <div class="mb-3 mb-sm-0 mr-sm-2 text-center w-100 w-sm-auto">
                <img src="{{asset('assets/vendors/images/author-2.jpg')}}" alt="Maggie Strickland">
            ...
            <div class="row mb-7">
              <div class="col-sm-6 mb-6">
                <div class="card">
                  <img src="{{asset('assets/vendors/images/blog-nav-01.jpg')}}"
              ...
              <div class="col-sm-6 mb-6">
                <div class="card">
                  <img src="{{asset('assets/vendors/images/blog-nav-02.jpg')}}"
                                 alt="How to Create an Effective Elevator Pitch" class="card-img">
                  <a href="#"
            ...
            <div class="media mb-6 pb-5 border-bottom">
              <div class="w-70px mr-2">
                <img src="{{asset('assets/vendors/images/review-05.jpg')}}"
                             alt="Dollie Horton">
              </div>
              <div class="media-body">
                <p class="text-heading fs-16 font-weight-500 mb-0">Dollie Horton</p>
            ...
            <div class="primary-sidebar-inner">
              ...
              <div class="card mb-4">
                <div class="card-body px-6 pt-5 pb-6">
                  ...
                  <img src="{{asset('assets/vendors/images/download-brochure.png')}}" alt="Download Brochure">
