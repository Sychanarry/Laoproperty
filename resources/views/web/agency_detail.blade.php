                ...
                <div class="card border-0 px-6 pt-6 pb-10">
                  <div class="row h-100">
                    <div class="col-sm-5 mb-6 mb-sm-0">
                      <img class="rounded-lg border card-img"
                                     src="{{asset('assets/vendors/images/agency-list-01.jpg')}}"
                      ...
                      <div class="card-body p-0">
                        ...
                        <ul class="list-group list-group-no-border">
                          <li class="list-group-item d-flex align-items-sm-center lh-214 row mx-n1 p-0 mb-2 mb-sm-0">
                            ...
                            <span class="col-sm-9 px-1 text-heading font-weight-500">123 900 68668</span>
                          </li>
                          <li class="list-group-item d-flex align-items-sm-center lh-214 row mx-n1 p-0 mb-2 mb-sm-0">
                          ...
                          <li class="list-group-item d-flex align-items-sm-center lh-214 row mx-n1 p-0 mb-2 mb-sm-0">
                            <span class="col-sm-3 px-1">Fax</span>
                            <span class="col-sm-9 px-1 text-heading font-weight-500">1-323 900 6800</span>
                          </li>
                          <li class="list-group-item d-flex align-items-sm-center lh-214 row mx-n1 p-0 mb-2 mb-sm-0">
                            <span class="col-sm-3 px-1">Email</span>
                            <span class="col-sm-9 px-1">hello@ecohouse.com</span>
                          </li>
                          <li class="list-group-item d-flex align-items-sm-center lh-214 row mx-n1 p-0 mb-2 mb-sm-0">
                          ...
                          <li class="list-group-item d-flex align-items-sm-center lh-214 row mx-n1 p-0 mb-2 mb-sm-0">
                            ...
                            <span class="col-sm-9 px-1">ecohousecompany.com</span>
                          </li>
                          <li class="list-group-item d-flex align-items-sm-center lh-214 row mx-n1 p-0 mb-2 mb-sm-0">
                            <span class="col-sm-3 px-1">Opening hours</span>
                            <span class="col-sm-9 px-1">08:00 AM - 06:00 PM</span>
                          </li>
                          <li class="list-group-item d-flex align-items-sm-center lh-214 row mx-n1 p-0 mb-2 mb-sm-0">
                            <span class="col-sm-3 px-1">Tax number</span>
                            <span class="col-sm-9 px-1">0838</span>
                          </li>
          ...
          <div class="container">
            <div class="collapse-tabs mb-10">
              <ul class="nav nav-tabs text-uppercase d-none d-md-inline-flex agent-details-tabs" role="tablist">
                <li class="nav-item">
                  <a href="#overview" class="nav-link active shadow-none fs-13"
                           data-toggle="tab" role="tab">
                    Overview
                  </a>
                </li>
                <li class="nav-item ml-0">
                  <a href="#listing" class="nav-link shadow-none fs-13"
                           data-toggle="tab" role="tab">
                    Listings
                  </a>
                </li>
                <li class="nav-item ml-0">
                  <a href="#agents" class="nav-link shadow-none fs-13"
                           data-toggle="tab" role="tab">
                    Agents
                  </a>
                </li>
                <li class="nav-item ml-0">
                  <a href="#reviews" class="nav-link shadow-none fs-13"
                           data-toggle="tab" role="tab">
                    Reviews
                  </a>
                </li>
                <li class="nav-item ml-0">
                  <a href="#agency-map" class="nav-link shadow-none fs-13"
                           data-toggle="tab" role="tab">
                    Map
                  </a>
                </li>
              ...
              <div class="tab-content shadow-none py-7 px-6 bg-white">
                <div id="collapse-tabs-accordion-01">
                  <div class="tab-pane tab-pane-parent fade show active" id="overview"
                             role="tabpanel">
                    <div class="card border-0 bg-transparent">
                      ...
                      <div id="overview-collapse" class="collapse show collapsible"
                        ...
                        <div class="card-body p-0">
                          ...
                          <p class="card-text lh-214 mb-3">Massa tempor nec feugiat nisl pretium. Egestas
                            fringilla
                            phasellus faucibus scelerisque eleifend donec. Porta nibh venenatis cras sed
                            felis eget velit aliquet. Neque volutpat ac tincidunt vitae semper quis
                            lectus. Turpis in eu mi bibendum neque egestas congue quisque. Sed elementum
                            tempus egestas sed sed risus pretium quam. Dignissim sodales ut eu sem. Nibh
                            mauris cursus mattis mole stie a iaculis at erat pellentesque. Id interdum
                            velit laoreet id donec ultrices tincidunt. Pelle ntesque eu tincidunt tortor
                            aliquam nulla facilisi cras fermentum odio. </p>
                          ...
                          <p class="card-text mb-6 mb-md-0">Massa tempor nec feugiat nisl pretium. Egestas
                            fringilla
                            phasellus faucibus scelerisque eleifend donec. Porta nibh venenatis cras sed
                            felis eget velit aliquet. Neque volutpat ac tincidunt vitae semper quis
                            lectus. Turpis in eu mi bibendum neque egestas congue quisque. Nibh mauris
                            cursus mattis molestie a iaculis at erat pellentesque. Massa tempor nec
                            feugiat nisl pretium. Egestas fringilla phasellus faucibus scelerisque
                            eleifend donec. Porta nibh venenatis cras sed felis eget velit aliquet.
                            Neque volutpat ac tincidunt vitae semper quis lectus. </p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="card border-0 bg-transparent">
                      ...
                      <div id="listing-collapse" class="collapse collapsible pb-5 pb-md-0"
                        ...
                        <div class="card-body p-0">
                          ...
                          <ul class="nav nav-pills text-capitalize nav-pills-01 mx-n5"
                                            role="tablist">
                          ...
                          <div class="tab-content shadow-none pt-5 pb-0 px-0 bg-white">
                            <div class="tab-pane nested-tab-pane fade show active" id="all"
                                                 role="tabpanel">
                              <div class="row">
                                  ...
                                  <div class="card border-0">
                                    ...
                                    <div class="card-body pt-3 px-0 pb-1">
                                      <h2 class="fs-16 mb-1"><a
                                                                        href="{{route('sale_properties_detail')}}"
                                ...
                                <div class="col-md-6 col-lg-4 mb-7">
                                  <div class="card border-0">
                                    ...
                                    <div class="card-body pt-3 px-0 pb-1">
                                      <h2 class="fs-16 mb-1"><a
                                                                        href="{{route('rent_properties_detail')}}"
                            ...
                            <div class="tab-pane nested-tab-pane fade" id="sale"
                                                 role="tabpanel">
                              <div class="row">
                                <div class="col-md-6 col-lg-4 mb-7">
                                  <div class="card border-0">
                            ...
                            <div class="tab-pane nested-tab-pane fade" id="rent"
                                                 role="tabpanel">
                              <div class="row">
                                <div class="col-md-6 col-lg-4 mb-7">
                                  <div class="card border-0">
                  ...
                  <div class="tab-pane tab-pane-parent fade" id="agents" role="tabpanel">
                    <div class="card border-0 bg-transparent">
                      <div class="card-header border-0 d-block d-md-none bg-transparent p-0">
                        <h5 class="mb-0">
                          <button class="btn lh-2 fs-18 bg-white py-1 px-6 shadow-none w-100 collapse-parent border collapsed mb-4"
                          ...
                          <div class="d-flex flex-wrap listing-agents">
                            ...
                            <div class="card border-0 px-7 mb-8">
                              <div class="card-body p-0 text-center">
                                <a href="{{route('agent_detail')}}"
                                                       class="d-block text-center">
                                  <img src="{{asset('assets/vendors/images/agent-30.jpg')}}"
                                                             class="mb-2"
                            ...
                            <div class="card border-0 px-7 mb-8">
                              <div class="card-body p-0 text-center">
                                <a href="{{route('agent_detail')}}"
                                                       class="d-block text-center">
                                  <img src="{{asset('assets/vendors/images/agent-31.jpg')}}"
                                                             class="mb-2"
                                                             alt="Kenneth Floyd">
                                </a>
                                <a href="{{route('agent_detail')}}"
                            ...
                            <div class="card border-0 px-7 mb-8">
                              <div class="card-body p-0 text-center">
                                <a href="{{route('agent_detail')}}"
                                                       class="d-block text-center">
                                  <img src="{{asset('assets/vendors/images/agent-43.jpg')}}"
                                                             class="mb-2"
                                                             alt="Oscar Austin">
                                </a>
                                <a href="{{route('agent_detail')}}"
                            ...
                            <div class="card border-0 px-7 mb-8">
                              <div class="card-body p-0 text-center">
                                <a href="{{route('agent_detail')}}"
                                                       class="d-block text-center">
                                  <img src="{{asset('assets/vendors/images/agent-44.jpg')}}"
                                                             class="mb-2"
                                                             alt="Danny Webb">
                                </a>
                                <a href="{{route('agent_detail')}}"
                            ...
                            <div class="card border-0 px-7 mb-8">
                              <div class="card-body p-0 text-center">
                                <a href="{{route('agent_detail')}}"
                                                       class="d-block text-center">
                                  <img src="{{asset('assets/vendors/images/agent-32.jpg')}}"
                                                             class="mb-2"
                                                             alt="Landon Allison">
                                </a>
                                <a href="{{route('agent_detail')}}"
                            ...
                            <div class="card border-0 px-7 mb-8">
                              <div class="card-body p-0 text-center">
                                <a href="{{route('agent_detail')}}"
                                                       class="d-block text-center">
                                  <img src="{{asset('assets/vendors/images/agent-33.jpg')}}"
                                                             class="mb-2"
                                                             alt="Irene Wallace">
                                </a>
                                <a href="{{route('agent_detail')}}"
                            ...
                            <div class="card border-0 px-7 mb-8">
                              <div class="card-body p-0 text-center">
                                <a href="{{route('agent_detail')}}"
                                                       class="d-block text-center">
                                  <img src="{{asset('assets/vendors/images/agent-34.jpg')}}"
                                                             class="mb-2"
                                                             alt="Tillie Clark">
                                </a>
                                <a href="{{route('agent_detail')}}"
                            ...
                            <div class="card border-0 px-7 mb-8">
                              <div class="card-body p-0 text-center">
                                <a href="{{route('agent_detail')}}"
                                                       class="d-block text-center">
                                  <img src="{{asset('assets/vendors/images/agent-45.jpg')}}"
                                                             class="mb-2"
                                                             alt="Martin Fletcher">
                                </a>
                                <a href="{{route('agent_detail')}}"
                            ...
                            <div class="card border-0 px-7 mb-8">
                              <div class="card-body p-0 text-center">
                                <a href="{{route('agent_detail')}}"
                                                       class="d-block text-center">
                                  <img src="{{asset('assets/vendors/images/agent-46.jpg')}}"
                                                             class="mb-2"
                                                             alt="Chase Tucker">
                                </a>
                                <a href="{{route('agent_detail')}}"
                  ...
                  <div class="tab-pane tab-pane-parent fade" id="agency-map" role="tabpanel">
                    <div class="card border-0 bg-transparent">
                      ...
                      <div id="map-collapse" class="collapse collapsible"
                                     data-parent="#collapse-tabs-accordion-01">
                        <div class="card-body p-0">
                          <h2 class="card-title fs-22 lh-15 mb-1 text-dark">
                            Visit our office
                          ...
                          <div class="map-responsive">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2682.490598892659!2d102.63445708654734!3d18.0430816314005!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31245d3b3d08b2f7%3A0x72dbccb62d358314!2sDongdok%20Campus%20Market!5e0!3m2!1sen!2sla!4v1639991999482!5m2!1sen!2sla"
                              height="500" style="border:0;width:100%;" allowfullscreen="" loading="lazy">
                            </iframe>
                        </div>
                        </div>
                      </div>
