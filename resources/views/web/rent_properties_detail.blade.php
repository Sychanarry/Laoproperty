          ...
          <article class="col-lg-8">
            <section class="pb-8 px-6 pt-6 bg-white rounded-lg">
              <ul class="list-inline d-sm-flex align-items-sm-center mb-2">
                ...
                <li class="list-inline-item mr-2 mt-2 mt-sm-0 fontfamily"><i class="fal fa-clock mr-1"></i>ວັນທີໂພສ: {{date('d/m/Y',strtotime($postestates[0]->post_date))}}</li>
              </ul>
              <div class="d-sm-flex justify-content-sm-between">
                ...
                <div class="mt-2 text-lg-right">
                  <p class="fs-22 text-heading font-weight-bold mb-0 fontfamily">ລາຄາ:{{number_format($postestates[0]->rent_price)}}{{$postestates[0]->rate_rent_price}}</p>
            ...
            <section class="mt-2 pb-7 px-6 pt-5 bg-white rounded-lg fontfamily">
              ...
              <ul class="list-unstyled mb-0 row no-gutters">
                  ...
                  @else
                  <li class="col-sm-3 col-6 mb-2"><i class="far fa-times-circle  mr-2 text-danger"></i>ສະຖານທີ່ອອກກຳລັງກາຍ</li>
                  @endif
                  @if ($postestatedetail[0]->swimming_pool)
                  <li class="col-sm-3 col-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>ສະລອຍນ້ຳ</li>
                  @else
                  <li class="col-sm-3 col-6 mb-2"><i class="far fa-times-circle  mr-2 text-danger"></i>ສະລອຍນ້ຳ</li>
                  @endif
                  @if ($postestatedetail[0]->lift)
                  <li class="col-sm-3 col-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>ມີລິບ</li>
                  @else
                  <li class="col-sm-3 col-6 mb-2"><i class="far fa-times-circle  mr-2 text-danger"></i>ມີລິບ</li>
                  @endif
                  ...
                  @else
                  <li class="col-sm-3 col-6 mb-2"><i class="far fa-times-circle  mr-2 text-danger"></i>ມີເສັ້ນທາງໃຫຍ່</li>
                  @endif
                  @if ($postestatedetail[0]->garden)
                  <li class="col-sm-3 col-6 mb-2"><i class="far fa-check mr-2 text-primary"></i>ມີສວນ</li>
                  @else
                  <li class="col-sm-3 col-6 mb-2"><i class="far fa-times-circle  mr-2 text-danger"></i>ມີສວນ</li>
                  @endif
                  ...
                  @else
                  <li class="col-sm-3 col-6 mb-2"><i class="far fa-times-circle  mr-2 text-danger"></i>ມີການລົງທືນ</li>
                  @endif
                  ...
                  @else
                  <li class="col-sm-3 col-6 mb-2"><i class="far fa-times-circle  mr-2 text-danger"></i>ເປັນມິດກັບຄົນຕ່າງປະເທດ</li>
                  @endif
                  ...
                  @else
                  <li class="col-sm-3 col-6 mb-2"><i class="far fa-times-circle  mr-2 text-danger"></i>ໃກ້ກັບສ່ວນສາທາລະນະ</li>
                  @endif
                  ...
                  @else
                  <li class="col-sm-3 col-6 mb-2"><i class="far fa-times-circle  mr-2 text-danger"></i>ໃກ້ກັບໂຮງຮຽນ</li>
                  @endif
                  ...
                  @else
                  <li class="col-sm-3 col-6 mb-2"><i class="far fa-times-circle  mr-2 text-danger"></i>ໃກ້ກັບຮ້ານຄ້າ</li>
                  @endif
              </ul>
            </section>
            ...
            <section class="mt-2 pb-7 px-6 pt-6 bg-white rounded-lg fontfamily">
              <div class="card border-0">
                <div class="card-body p-0">
                  ...
                  <form action="{{route('comment.store')}}"  method="POST" class="form fontfamily">
                    @csrf
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group mb-4">
                          <input placeholder="ຊື່" class="form-control form-control-lg border-0" type="text" name="name">
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group mb-4">
                          <input type="text" placeholder="ອີເມວ" name="email" class="form-control form-control-lg border-0">
                        </div>
                      </div>
                    </div>
                    <div class="form-group mb-6">
                      <textarea class="form-control form-control-lg border-0" placeholder="ເນື້ອໃນ" name="message" rows="5"></textarea>
                    </div>
