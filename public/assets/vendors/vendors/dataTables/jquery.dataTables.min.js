...
(function(k){"function"===typeof define&&define.amd?define(["jquery"],function(y){return k(y,window,document)}):"object"===typeof exports?module.exports=function(y,z){y||(y=window);z||(z="undefined"!==typeof window?require("jquery"):require("jquery")(y));return k(z,y,y.document)}:k(jQuery,window,document)})(function(k,y,z,q){function G(a){var b,c,d={};k.each(a,function(e,f){(b=e.match(/^([^A-Z]+?)([A-Z])/))&&-1!=="a aa ai ao as b fn i m o s ".indexOf(b[1]+" ")&&(c=e.replace(b[0],b[2].toLowerCase()),
	...
	u.versionCheck=u.fnVersionCheck=function(a){var b=u.version.split(".");a=a.split(".");for(var c,d,e=0,f=a.length;e<f;e++)if(c=parseInt(b[e],10)||0,d=parseInt(a[e],10)||0,c!==d)return c>d;return!0};u.isDataTable=u.fnIsDataTable=function(a){var b=k(a).get(0),c=!1;if(a instanceof u.Api)return!0;k.each(u.settings,function(d,e){d=e.nScrollHead?k("table",e.nScrollHead)[0]:null;var f=e.nScrollFoot?k("table",e.nScrollFoot)[0]:null;if(e.nTable===b||d===b||f===b)c=!0});return c};u.tables=u.fnTables=function(a){var b=
		...
		fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"ຖັດໄປ",sPrevious:"ກັບຄືນ"},sEmptyTable:"ບໍ່ຂໍ້ມູນທີ່ຈະສະແດງ",sInfo:"ສະແດງຈາກ _START_ ຫາ _END_ ຂອງ _TOTAL_ ລາຍການ",sInfoEmpty:"ສະແດງ 0 ຫາ 0 ຂອງ 0 ລາຍການ",sInfoFiltered:"(ກັ່ນຂໍ້ມູນ ຈາກ _MAX_ ລາຍການ)",
			sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"ສະແດງ _MENU_ ລາຍການ",sLoadingRecords:"ກຳລັງໂຫຼດຂໍ້ມູນ...",sProcessing:"ກໍາລັງປະມວນຜົນຂໍ້ມູນ...",sSearch:"ຄົ້ນຫາ:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"ບໍ່ພົບຂໍ້ມູນທີ່ທ່ານຄົ້ນຫາ"},oSearch:k.extend({},u.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};G(u.defaults);u.defaults.column={aDataSort:null,
